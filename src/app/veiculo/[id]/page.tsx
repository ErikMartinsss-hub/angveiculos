              ...
              <div className="lg:sticky lg:top-6 space-y-6">
                <div className="bg-white rounded-2xl p-6 border border-gray-100 shadow-sm">
                  ...
                  <div className="space-y-3">
                    <a
                      href={`https://wa.me/5511947831797?text=Olá! Fiquei interessado no ${vehicle.marca} ${vehicle.modelo} ${vehicle.ano_fabricacao} - ${vehicle.km.toLocaleString("pt-BR")} km, ${vehicle.combustivel || ""} por ${formattedPreco}. Gostaria de saber mais sobre o veículo.`}
                      target="_blank"
                    ...
                    <a
                      href={`https://wa.me/5511942398993?text=Olá! Fiquei interessado no ${vehicle.marca} ${vehicle.modelo} ${vehicle.ano_fabricacao} - ${vehicle.km.toLocaleString("pt-BR")} km, ${vehicle.combustivel || ""} por ${formattedPreco}. Gostaria de saber mais sobre o veículo.`}
                      target="_blank"
